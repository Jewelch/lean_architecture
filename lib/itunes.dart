...
//   Future<Map?> lookupByBundleId(String bundleId, {String? country = 'US', bool useCacheBuster = true}) async {
//     assert(bundleId.isNotEmpty);
//     if (bundleId.isEmpty) {
//       return null;
//     }

//     final url = lookupURLByBundleId(bundleId, country: country ?? '', useCacheBuster: useCacheBuster)!;
//     if (debugLogging) {
...
//   Future<Map?> lookupById(String id, {String country = 'US', bool useCacheBuster = true}) async {
//     if (id.isEmpty) {
//       return null;
//     }
...
//   /// ```lookupURLByBundleId('com.google.Maps');```
//   /// ```lookupURLByBundleId('com.google.Maps', country: 'FR');```
//   String? lookupURLByBundleId(String bundleId, {String country = 'US', bool useCacheBuster = true}) {
//     if (bundleId.isEmpty) {
//       return null;
//     }

//     return lookupURLByQSP({'bundleId': bundleId, 'country': country.toUpperCase()}, useCacheBuster: useCacheBuster);
//   }
...
//   String? lookupURLById(String id, {String country = 'US', bool useCacheBuster = true}) {
//     if (id.isEmpty) {
//       return null;
//     }

//     return lookupURLByQSP({'id': id, 'country': country.toUpperCase()}, useCacheBuster: useCacheBuster);
//   }

//   /// Look up URL by QSP.
//   String? lookupURLByQSP(Map<String, String?> qsp, {bool useCacheBuster = true}) {
//     if (qsp.isEmpty) {
//       return null;
//     }
...
//         if (resultCount == 0) {
//           if (debugLogging) {
//             print('upgrader.ITunesSearchAPI: results are empty: $decodedResults');
//           }
//           return null;
//         }
//         return decodedResults;
...
//   final args = ["bundleid=com.rides2u.rides2u"];
//   // if (arguments.length == 1) {
//   final arg0 = args[0].split('=');
//   if (arg0.length == 2) {
