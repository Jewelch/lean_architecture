...
//     SharedPartBuilder([const SheetLocalizationGenerator()], 'flutter_sheet_localization');
...
//       final name = element.name;
//       throw InvalidGenerationSourceError('Generator for target `$name` should have a name that ends with `Delegate`.',
//           todo: 'Refactor the class name `$name` for a name ending with `Delegate` (example: `${name}Delegate`).',
//           element: element);
//     }
...
//         ))
//         .toList();
//     const parser = CsvLocalizationParser();
