...
class GetItContainer extends DependecyInjectionContainer {
  ...
  void registerSingleton<T extends Object>(
    ...
    if (isRegistered<T>(name: name)) return;
    actor.registerSingleton(instance, instanceName: name, signalsReady: signalsReady, dispose: dispose);
  }
  ...
  void registerSingletonAsync<T extends Object>(
    ...
    if (isRegistered<T>(name: name)) return;
    actor.registerSingletonAsync(() => factoryFunc(),
        instanceName: name, dependsOn: dependsOn, signalsReady: signalsReady, dispose: dispose);
  }
